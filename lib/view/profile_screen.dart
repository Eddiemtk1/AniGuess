...
class _ProfileScreen extends State<ProfileScreen> {
  ...
  Future<void>updateProfileImage(Uint8List imageBytes) async{
    ...
    try{
      ...
      await FirebaseFirestore.instance.collection("userData").doc(user!.uid).set({"photoBase64":base64Image}, SetOptions(merge: true),);
      setState(() {
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: MyButton(onTap: signOut, buttontext: "Sign Out"),
                      ),
                    ],
                  ),
                ],
